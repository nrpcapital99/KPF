...
function toVolunteer(id: string, data: DocumentData): Volunteer {
  return {
    ...
    email: data.email ?? "",
    city: data.city ?? null,
    helpWith: Array.isArray(data.helpWith) ? data.helpWith : [],
    digitalSpecifics: data.digitalSpecifics ?? null,
    techSpecifics: data.techSpecifics ?? null,
    otherContribution: data.otherContribution ?? null,
    legacyInterests: Array.isArray(data.interests) ? data.interests : [],
